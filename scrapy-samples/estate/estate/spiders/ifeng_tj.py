...
class IfengTjSpider(CrawlSpider):
    name = "ifeng_tj"
    ...
    urls = [
        'http://tj.house.ifeng.com/news/policy/{}',
        'http://tj.house.ifeng.com/news/market/{}',
        'http://tj.house.ifeng.com/news/society/{}',
        'http://tj.house.ifeng.com/news/survey/{}',
    ]
    ...
    def parse_post(self, response):
        ...
        if item_url.startswith('http://tj.house.ifeng.com/detail/'):
