...
class SohuGzSpider(CrawlSpider):
    name = "sohu_gz"
    ...
    start_urls = (
        'http://gz.focus.cn/newscenter/news-bendixinwen/p1/',
        'http://gz.focus.cn/newscenter/news-shichangdongtai/p1',
        'http://gz.focus.cn/newscenter/news-hongguanzhengce/p1',
    )
    ...
    def parse_post(self, response):
        ...
        if post_url.startswith('http://gz.focus.cn/news/'):
            item = EstateItem()
