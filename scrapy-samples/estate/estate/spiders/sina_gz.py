...
class SinaGzSpider(CrawlSpider):
    name = "sina_gz"
    ...
    start_urls = (
        'http://search.house.sina.com.cn/gz/news/page01/',
    )

    rules = (
        Rule(LinkExtractor(allow=('/gz/news/page\d+/',)), follow=True),
    ...
    def parse_post(self, response):
        ...
        if post_url.startswith('http://gz.house.sina.com.cn/news/'):
            item = EstateItem()
