...
class SohuXmSpider(CrawlSpider):
    name = "sohu_xm"
    ...
    start_urls = (
        'http://xm.focus.cn/newscenter/news-bendixinwen/p1/',
        'http://xm.focus.cn/newscenter/news-shichangdongtai/p1',
        'http://xm.focus.cn/newscenter/news-hongguanzhengce/p1',
    )
    ...
    def parse_post(self, response):
        ...
        if post_url.startswith('http://xm.focus.cn/news/'):
            item = EstateItem()
