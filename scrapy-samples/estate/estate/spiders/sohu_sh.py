...
class SohuShSpider(CrawlSpider):
    ...
    start_urls = (
        'http://sh.focus.cn/newscenter/news-bendixinwen/p1/',
        'http://sh.focus.cn/newscenter/news-shichangdongtai/p1',
        'http://sh.focus.cn/newscenter/news-hongguanzhengce/p1',
    )
    ...
    def parse_post(self, response):
        ...
        if post_url.startswith('http://sh.focus.cn/news/'):
            item = EstateItem()
