...
class SohuBjSpider(CrawlSpider):
    name = "sohu_bj"
    ...
    start_urls = (
        'http://house.focus.cn/newscenter/news-bendixinwen/p1/',
        'http://house.focus.cn/newscenter/news-shichangdongtai/p1',
        'http://house.focus.cn/newscenter/news-hongguanzhengce/p1',
    )
    ...
    def parse_post(self, response):
        ...
        if post_url.startswith('http://house.focus.cn/news/'):
            item = EstateItem()
