...
class SohuCqSpider(CrawlSpider):
    name = "sohu_cq"
    ...
    start_urls = (
        'http://cq.focus.cn/newscenter/news-bendixinwen/p1/',
        'http://cq.focus.cn/newscenter/news-shichangdongtai/p1',
        'http://cq.focus.cn/newscenter/news-hongguanzhengce/p1',
    )
    ...
    def parse_post(self, response):
        ...
        if post_url.startswith('http://cq.focus.cn/news/'):
            item = EstateItem()
