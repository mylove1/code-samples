...
class IfengBjSpider(CrawlSpider):
    name = "ifeng_bj"
    ...
    urls = [
        'http://house.ifeng.com/news/policy/{}',
        'http://house.ifeng.com/news/market/{}',
        'http://house.ifeng.com/news/society/{}',
        'http://house.ifeng.com/news/survey/{}'
    ]
    ...
    def parse_post(self, response):
        ...
        if item_url.startswith('http://house.ifeng.com/detail/'):
