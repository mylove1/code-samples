...
class SohuTjSpider(CrawlSpider):
    name = "sohu_tj"
    ...
    start_urls = (
        'http://tj.focus.cn/newscenter/news-bendixinwen/p1/',
        'http://tj.focus.cn/newscenter/news-shichangdongtai/p1/',
        'http://tj.focus.cn/newscenter/news-hongguanzhengce/p1/',
    )
    ...
    def parse_post(self, response):
        ...
        if post_url.startswith('http://tj.focus.cn/news/'):
            item = EstateItem()
