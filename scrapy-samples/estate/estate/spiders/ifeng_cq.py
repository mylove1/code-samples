...
class IfengCqSpider(CrawlSpider):
    name = "ifeng_cq"
    ...
    urls = [
        'http://cq.house.ifeng.com/news/policy/{}',
        'http://cq.house.ifeng.com/news/market/{}',
        'http://cq.house.ifeng.com/news/society/{}',
        'http://cq.house.ifeng.com/news/survey/{}',
    ]
    ...
    def parse_post(self, response):
        ...
        if item_url.startswith('http://cq.house.ifeng.com/detail/'):
