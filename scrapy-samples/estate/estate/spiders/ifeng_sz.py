...
class IfengSzSpider(CrawlSpider):
    name = "ifeng_sz"
    ...
    urls = [
        'http://sz.house.ifeng.com/news/policy/{}',
        'http://sz.house.ifeng.com/news/market/{}',
        'http://sz.house.ifeng.com/news/society/{}',
        'http://sz.house.ifeng.com/news/survey/{}',
    ]
    ...
    def parse_post(self, response):
        ...
        if item_url.startswith('http://sz.house.ifeng.com/detail/'):
