...
class IfengShSpider(CrawlSpider):
    name = "ifeng_sh"
    ...
    urls = [
        'http://sh.house.ifeng.com/news/policy/{}',
        'http://sh.house.ifeng.com/news/market/{}',
        'http://sh.house.ifeng.com/news/society/{}',
        'http://sh.house.ifeng.com/news/survey/{}',
    ]
    ...
    def parse_post(self, response):
        ...
        if item_url.startswith('http://sh.house.ifeng.com/detail/'):
